...
public class Robot extends TimedRobot {
  ...
  private Joystick operatorControler = new Joystick(ControlerConstants.PORT_ID_OPERATOR_CONTROLER);
  ...
  public void teleopPeriodic() {
    int timeLeft = (int)Timer.getMatchTime();
    if(timeLeft == 90 || timeLeft == 60 || timeLeft == 30 || timeLeft == 20 || timeLeft == 10 ){
      operatorControler.setRumble(RumbleType.kLeftRumble, 1);
      operatorControler.setRumble(RumbleType.kRightRumble, 1);
